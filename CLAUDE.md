...
poetry run behave -f allure_behave.formatter:AllureFormatter -o allure-results
...
### Allure Reporting
```bash
# Generate and serve Allure report (after running tests with Allure formatter)
